class Admin::MenusController < Admin::BaseController
  ...
  def index
    @admin_menus = Admin::Menu.order('sort').all
  end
  ...
  def create
    ...
    respond_to do |format|
      if @admin_menu.save
        format.html { redirect_to admin_menus_url, notice: 'Menü Linki Oluşturuldu.' }
  ...
  def update
    respond_to do |format|
      if @admin_menu.update(admin_menu_params)
        format.html { redirect_to edit_admin_menu_path(@admin_menu), notice: 'Menü Linki Güncellendi.' }
  ...
  def destroy
    @admin_menu.destroy
    respond_to do |format|
      format.html { redirect_to admin_menus_url, notice: 'Menü Linki Silindi.' }
  ...
  private
    ...
    def admin_menu_params
      params.require(:admin_menu).permit(:title, :desc, :url, :sort, :target, :status)
    end
end
